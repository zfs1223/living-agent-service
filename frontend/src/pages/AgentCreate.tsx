...
export default function AgentCreate() {
    ...
    const [form, setForm] = useState({
        ...
        // 个人模式下默认为仅自己可见
        permission_scope_type: isPersonalMode ? 'user' : 'company',
                ...
                {step === 3 && (
                    <div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '20px' }}>
                            {[
                                { value: 'company', label: t('wizard.step4.companyWide'), desc: t('wizard.step4.companyWideDesc'), disabled: isPersonalMode },
                                { value: 'user', label: t('wizard.step4.selfOnly'), desc: t('wizard.step4.selfOnlyDesc'), disabled: false },
                            ].map((scope) => (
                                <label key={scope.value} style={{
                                    ...
                                    <input type="radio" name="scope"
                                        ...
                                        onChange={() => !scope.disabled && setForm({ ...form, permission_scope_type: scope.value })} />
