            ...
            <nav className={`sidebar ${isSidebarCollapsed ? 'collapsed' : ''}`}>
                <div className="sidebar-top">
                    <div className="sidebar-logo">
                        ...
                        <span className="sidebar-logo-text">Living Agent</span>
                    ...
                    <div className="sidebar-section">
                        <div className="sidebar-section-title">{isChinese ? '部门' : 'Departments'}</div>
                        {Object.entries(DEPARTMENTS).map(([code, info]) => (
                            ...
                            >
                                ...
                                <span className="sidebar-item-text">{isChinese ? info.name : info.name_en}</span>
                            </NavLink>
                        ))}
                    </div>
                </div>
