...
public enum UserIdentity {
    ...
    INTERNAL_ENTERPRISE("董事长", AccessLevel.FULL, true),
    ...
    public boolean isInternal() {
        return this == INTERNAL_ENTERPRISE || this == INTERNAL_ACTIVE || this == INTERNAL_PROBATION || this == INTERNAL_DEPARTED;
    }

    public boolean isActiveEmployee() {
        return this == INTERNAL_ENTERPRISE || this == INTERNAL_ACTIVE || this == INTERNAL_PROBATION;
    }
    ...
    public boolean isEnterprise() {
        return this == INTERNAL_ENTERPRISE;
    }
}
