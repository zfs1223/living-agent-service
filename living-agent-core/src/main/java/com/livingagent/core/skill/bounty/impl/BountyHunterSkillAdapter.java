...
public class BountyHunterSkillAdapter implements Skill {

    private static final Logger log = LoggerFactory.getLogger(BountyHunterSkillAdapter.class);
...
- limit: Maximum number of results to return
    ...
    public BountyHunterSkillAdapter(BountyHunterService bountyHunterService) {
